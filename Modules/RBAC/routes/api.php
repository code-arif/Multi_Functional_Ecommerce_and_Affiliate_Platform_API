...
Route::middleware(['auth:sanctum', 'admin', 'banned'])
    ...
    ->group(function () {
        ...
        Route::get('permissions/groups', [PermissionController::class, 'groups'])->middleware('permission:permissions.view');
        Route::get('permissions/grouped', [PermissionController::class, 'grouped'])->middleware('permission:permissions.view');
